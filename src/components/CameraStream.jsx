    ...
    >
      {youtubeUrls.map((videoId, index) => (
        ...
        <iframe
          ...
          src={`https://www.youtube.com/embed/live_stream?channel=UCxjcbWh1Rh3XdiFomLHSfNg&autoplay=1&mute=1&controls=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&fs=0&disablekb=1&playsinline=1&enablejsapi=1&cc_load_policy=0`}
          title="Nas Stream"
          frameBorder="0"
